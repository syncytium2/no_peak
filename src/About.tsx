  ...
  return (
    <div className="about">
      ...
      <p className="lede">
        ...
        Johnson. It runs the <strong>original Fortran</strong> — a faithful port of CLUST5 v6.01,
        the program they published — and carries a port of the Igor Pro implementation used in the
        Moenter Lab alongside it, for reproducing analyses done there.
      </p>
      <p>
      ...
      <ul>
        <li>
          ...
          that paper&apos;s own pulse calls. Detection depends on it: at one-point windows the local
          error estimators let a clean tall pulse inflate its own error and hide itself, and the
          count swings with the estimator chosen — on ewe #9013, from 0 pulses with Local SD to 21
          with Global SE.
        </li>
        <li>
      ...
      <p>
        ...
        distortion washes out. Wider windows do not make it safe: at two-point windows, rescaling a
        pulse-free record by 10,000 takes the Igor variant from 0 pulses to 16. At one-point
        windows — which is what several published analyses specify — it is severe, and the app says
        so when you select them.
      </p>
      <p>
        The Igor variant preserves this rather than correcting it, because Igor Pro is that
        variant&apos;s validation oracle and silently diverging from it would make it untestable. If you
      ...
      <p>
        ...
        records yield anywhere from no pulses at all to 116 detections — depending on nothing but
      ...
      <ul>
        ...
        <li>
          ...
          the Igor variant. Its numbers are the ones that variant is tested against.
        </li>
      </ul>
      <p>
        ...
        up-flag. A separate checkbox switches the interface to the green-phosphor terminal look
        the program originally ran under.
      </p>
      <p>
      ...
      <p>
        The Igor Pro port that no_peak&apos;s Igor variant is validated against was introduced in Vanacker et al.
        ...
        cluster sizes of 2 points for both peak and nadir with t-scores of 2, which are
        no_peak&apos;s generic defaults.
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        no_peak disagrees with Igor, or with the original Fortran at symmetric windows, that is a
        bug worth reporting: please get in touch with the data and parameters.
      </p>
