...
// They were re-read from the library's scan of the bound PRINT volume on
// 2026-08-19, replacing a reading of the publisher's PDF; the source of the
// copy is the whole of the rights position, and the numbers moved slightly in
// the process. See data/digitized/README.md and
// tools/digitize_webster_print.py, and docs/figure-data-permissions.md for the
// rights position, its limits, and why no claim of an author's permission
...
const DIGITIZED: DigitizedRecord[] = [
  ...
  },
  {
    ...
    valueLabel: "GnRH (pg/min)",
    citation:
      "Digitized from Webster JR, Moenter SM, Barrell GK, Lehman MN, Karsch FJ, Endocrinology 1991;129(3):1635-43 (PMID 1874193), Fig. 4B, ewe #9009. Read off the University of Michigan library's scan of the bound print volume (not the publisher's PDF); values are approximate to the width of a printed line. The error bars are RECONSTRUCTED, not measured: the figure prints none and the paper does not report its per-sample error, so the file supplies max(floor, 0.08 x value).",
